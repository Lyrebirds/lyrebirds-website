...
export const OUR_SERVICES: Service[] = [
    ...
    },
    {
        ...
        intro: `Your data is your business, but are you prepared to lose it? Data can be lost to a destructive attack, or by unfortunate accidents. Securing your data is a vital precaution, and recovery must be available on demand. We can help you create and evaluate your data security strategy, while making sure that you stay compliant with modern laws such as GDPR or the Cookie directive.`,
        body: []
    },
]