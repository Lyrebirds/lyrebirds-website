...
const routes: Routes = [
  ...
  { path: 'news/' + CABLEHAUNT_VULNERABILITY_URL_KEY, component: CableHauntVulnerabilityComponent },
  { path: 'news/' + BROADCOM_HTTPD_ERROR_URL_KEY, component: TechnicolorHttpdServerVulnerabilityComponent },
